...
amfg = ANAModuleFactoriesGenerator(qs)
feug = FunctionalEquivalenceUnitGenerator(amfg)
...
# -------------------------------------------------------------------------------
# 4 * 2 * 3 * 3 * 4 = 288 tests
(x_gen_cpu, module_cpu, grad_gen_cpu), (x_gen_gpu, module_gpu, grad_gen_gpu) = feug.get_test_unit('uniform', -0.5, 1.0, 0, BatchSize.SMALL, InputSize.NORMAL, TestModule.ACTIVATIONLINEAR)
...
# ----------------------------------------------------------------------------
# 4 * 3 * 3 * 3 * 2 = 216 tests
(x_gen_cpu, module_cpu, grad_gen_cpu), (x_gen_gpu, module_gpu, grad_gen_gpu) = feug.get_test_unit('uniform', -0.5, 1.0, 2, BatchSize.SMALL, InputSize.NORMAL, TestModule.ACTIVATIONCONV2D)
...
# ----------------------------------------------------------------------------
# 4 * 3 * 3 * 3 * 2 = 216 tests
(x_gen_cpu, module_cpu, grad_gen_cpu), (x_gen_gpu, module_gpu, grad_gen_gpu) = feug.get_test_unit('uniform', -0.5, 1.0, 2, BatchSize.SMALL, InputSize.NORMAL, TestModule.CONV2D)
visual_equivalence(x_gen_cpu, module_cpu, grad_gen_cpu, x_gen_gpu, module_gpu, grad_gen_gpu)
