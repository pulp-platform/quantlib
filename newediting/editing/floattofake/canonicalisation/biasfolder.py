...
from quantlib.newediting.editing.editors.pathgraphs import ModuleDescription, PathGraphDescription, PathGraphRewriter
from quantlib.newediting.editing.editors.base import ApplicationPoint, ComposedEditor
