...
from quantlib.newediting.editing.editors import ModuleDescription, PathGraphDescription, PathGraphRewriter
from quantlib.newediting.editing.editors import ApplicationPoint, ComposedEditor
...
class Requantiser(PathGraphRewriter):
    ...
    def _apply(self, g: fx.GraphModule, ap: ApplicationPoint) -> fx.GraphModule:
        ...
        new_module = Requant(mul=gamma_int, add=beta_int, zero=module_qactivation.zero, n_levels=module_qactivation.n_levels, D=self._D)
