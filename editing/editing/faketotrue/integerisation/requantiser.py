...
from ....graphs import EpsTunnel, Requantisation
from quantlib.algorithms.qmodules import QReLU
...
class Requantiser(Rewriter):
    ...
    def _apply(self, g: fx.GraphModule, ap: ApplicationPoint) -> fx.GraphModule:
        ...
        new_module = Requantisation(mul=gamma_int, add=beta_int, zero=qrelu_module.zero, n_levels=qrelu_module.n_levels, D=self._D)
