...
def eps_conversion_invalid(m: torch.nn.Module, *eps_in: torch.Tensor,
                           **kw_eps_in: torch.Tensor):
...
class QuantInfo:
    # >>><<<
    # spmatteo: this is a "container" class meant to have two modifiable name attributes;
    #           the intent is using one such object for each module, to annotate the
    #           corresponding module with input/output quanta information
    eps_in: torch.Tensor
